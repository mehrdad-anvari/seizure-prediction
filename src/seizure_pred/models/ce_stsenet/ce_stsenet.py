...
@MODELS.register("ce_stsenet", help="CE-stSENet imported from original seizure-prediction-main/models/CE_stSENet")
def build_ce_stsenet(cfg: ModelConfig):
